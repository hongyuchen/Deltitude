...
static void down_single_click_handler(ClickRecognizerRef recognizer, void *context) {
  ...
  if (force_mode) {
    ...
    s_timer_layer = text_layer_create(GRect(5, 30, window_bounds.size.w - 10, 30));
    ...
    s_timer_label_layer = text_layer_create(GRect(5, 5, window_bounds.size.w - 10, 30));
    ...
    s_average_freq_layer = text_layer_create(GRect(5, 75, window_bounds.size.w - 10, 30));
...
static void top_single_click_handler(ClickRecognizerRef recognizer, void *context) {
  Window *window = (Window *)context;
  Layer *window_layer = window_get_root_layer(window);
  GRect window_bounds = layer_get_bounds(window_layer);
...
static void config_provider(Window *window) {
  ...
  window_single_click_subscribe(BUTTON_ID_UP, top_single_click_handler);
}
